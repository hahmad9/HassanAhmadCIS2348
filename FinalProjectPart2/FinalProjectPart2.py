...
# Prompt the user for input
    ...
    while user_input != 'q':
        ...
        user_input = input(
            "\nPlease enter an item manufacturer and item type (ex: Samsung phone) or enter 'q' to quit:\n")
        ...
        if user_input == 'q':
            ...
            print("manufacturer: ", selected_manufacturer)

            print("type: ", selected_type)

            print("manufacturer and type", (selected_manufacturer != None and selected_type != None))
                    ...
                    if similar_items:
                        ...
                        for item in similar_items:
                            ...
                            if price_diff < closest_price_diff:
                                ...
                                item_type = similar_items[item]['item_type']
                                price = similar_items[item]['price']
                        print("Consider these as well: {}, {}, {}, {}\n".format(item_id, man_name, item_type, price))

            else:
                print("The Inventory is missing this item.")